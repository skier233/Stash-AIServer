...
"""Plugin loader (migrated from app.plugins.loader).

This file was moved out of the `app.plugins` package so that the `plugins/`
...
from app.models.plugin import PluginMeta, PluginSetting, PluginSource
from app.plugin_runtime.settings_registry import register_settings
import httpx
